...
//Code Here
let evenNumbers = mixedNumbers.filter(function(value){
  return value%2===0;
})
...
//Code Here
let postTaxPrices = prices.map(p => (p + (p*0.07)));
...
//Code Here
let totalPopulation = populations.reduce(((total, pop) => total+= pop), 0)

// let totalPopulation = funciton(populations.reduce(((total, pop) => toatl+= pop), 0))
