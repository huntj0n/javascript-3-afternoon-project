...
function secrets(obj){
  let str = "";
  for(var k in obj){
    if (k.startsWith('sh')){ //why does this work? why does obj[k].startsWith('sh) not work?
      str += obj[k];
    }
  }
  return str
...
deleteLeBigNums(deleteTheBigNumbers)
